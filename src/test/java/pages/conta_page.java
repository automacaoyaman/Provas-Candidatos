...
public class conta_page {
	...
	/*massa de dados*/
	private static String nomeConta      = "Yamano";
	private static String txt_msg_sucess = "Conta adicionada com sucesso!";
	private static String txt_msg_error  = "Já existe uma conta com esse nome!";
