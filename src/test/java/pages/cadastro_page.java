...
public class cadastro_page {
	...
	private static String set_nome       = "Yamano 18";
	private static String set_email      = "yaman199@yaman.com.br";
	private static String set_senha      = "123456789";
	
	private static String txt_msg_sucess = "Usuário inserido com sucesso";
	private static String txt_msg_error  = "Endereço de email já utilizado";
